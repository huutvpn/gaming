...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/huutvpn/gaming/main/register > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/huutvpn/gaming/main/register | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/huutvpn/gaming/main/register | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/huutvpn/gaming/main/register | grep $MYIP | awk '{print $3}')
fi
...
echo -e "  ${z}│ [${r}06${NC}] ${z}UPDATE SCRIPT${NC}       ""[${r}12${NC}] ${z}ZIP VPN      ${NC}
  ${z}│ [${r}13${NC}] ${z}BOT TELEGRAM ${NC}      ${NC}"
echo -e "  ${z}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m${NC}"
echo -e "${z}┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m${NC}" 
